...
import { ArrowLeft, Maximize2, X, CheckCircle2, Facebook, Instagram, Mail } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto flex flex-col items-center gap-8">
          <div className="flex gap-6">
            {[
              ...
              { icon: Mail, label: 'Email', href: 'mailto:info@baltasdvaras.lt' }
            ].map((social) => (
              <a
                key={social.label}
                href={social.href}
          ...
          <p className="text-gray-400 text-[10px] tracking-widest uppercase">
            © 2026 Baltas Dvaras. Visos teisės saugomos.
          </p>
        </div>
      </footer>
    </div>
